...
class Turbina_Rawson(Turbina):
    ...
    def __init__(self, coord):
        d_0 = 90
        self.U_tabulado = np.array([  3.97553683,   4.9669611 ,   5.95972269,   6.95196727,
    ...
    def c_T_tabulado(self, U):
        ...
        tck = interpolate.splrep(self.U_tabulado, c_T_tabulado, s=0)
    ...
    def P_tabulado(self, U):
        ...
        tck = interpolate.splrep(self.U_tabulado, P_tabulado, s=0)
    ...
    def c_P_tabulado(self, U):
        ...
        tck = interpolate.splrep(self.U_tabulado, c_P_tabulado, s=0)
