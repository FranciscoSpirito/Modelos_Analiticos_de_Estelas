...
meshZmin, meshZmax, npoiZ = 80-45-20, 80+45+20, 50
meshYmin, meshYmax, npoiY = 2500-3*d0, 2500+3*d0, 50
...
# Ploteo
VG = griddata((positions[0], positions[1]), velocidades, (YG, ZG), method='linear')
fig1 = plt.figure()
ax = fig1.add_subplot(1, 1, 1)
count = ax.contourf(YG,ZG,VG)
fig1.colorbar(count)
plt.show()